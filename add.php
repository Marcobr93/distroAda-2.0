...
if(!empty($_POST) ){
    ...
    if ($description === ""){
        ...
        if ( empty($errors) ) {
            ...
            $sql = "INSERT INTO distro (image, name, ostype, basedon, origin, architecture, desktop, category, status, version, web, doc, forum, error, description) VALUES (:image, :name, :ostype, :basedon, :origin, :architecture, :desktop, :category, :status, :version, :web, :doc, :forum, :error, :description)";
...
<div class="container">
    ...
    <form action="add.php" method="post">
        ...
        <?php if( isset($errors['name']) ): ?>
            <?php foreach ($errors['name'] as $valor): ?>
                <p class="bg-danger"><?=$valor?></p>
            <?php endforeach; ?>
        <?php endif; ?>
        <div class="form-group">
            <label for="image">Image</label>
            <input type="text" class="form-control" id="image" name="image" placeholder="Distro Image URL">
        </div>
        ...
        <div class="form-group">
            ...
            <select class="form-control" name="basedon[]" id="basedon" multiple required>
        ...
        <?php if( isset($errors['basedon']) ): ?>
            <?php foreach ($errors['basedon'] as $valor): ?>
                <p class="bg-danger"><?=$valor?></p>
            <?php endforeach; ?>
        <?php endif; ?>
        <div class="form-group">
        ...
        <?php if( isset($errors['origin']) ): ?>
            <?php foreach ($errors['origin'] as $valor): ?>
                <p class="bg-danger"><?=$valor?></p>
            <?php endforeach; ?>
        <?php endif; ?>
        <div class="form-group">
            <label for="architecture">Architecture</label>
            <select class="form-control" name="architecture[]" id="architecture" multiple required>
                <option selected value="All">All</option>
        ...
        <?php if( isset($errors['architecture']) ): ?>
            <?php foreach ($errors['architecture'] as $valor): ?>
                <p class="bg-danger"><?=$valor?></p>
            <?php endforeach; ?>
        <?php endif; ?>
        <div class="form-group">
            <label for="desktop">Desktop</label>
            <select class="form-control" name="desktop[]" id="desktop"  multiple required>
                <option selected value="All">All</option>
        ...
        <?php if( isset($errors['desktop']) ): ?>
            <?php foreach ($errors['desktop'] as $valor): ?>
                <p class="bg-danger"><?=$valor?></p>
            <?php endforeach; ?>
        <?php endif; ?>
        ...
        <?php if( isset($errors['category']) ): ?>
            <?php foreach ($errors['category'] as $valor): ?>
                <p class="bg-danger"><?=$valor?></p>
            <?php endforeach; ?>
        <?php endif; ?>
        <div class="form-group">
        ...
        <?php if( isset($errors['status']) ): ?>
            <?php foreach ($errors['status'] as $valor): ?>
                <p class="bg-danger"><?=$valor?></p>
            <?php endforeach; ?>
        <?php endif; ?>
        <div class="form-group">
        ...
        <?php if( isset($errors['version']) ): ?>
            <?php foreach ($errors['version'] as $valor): ?>
                <p class="bg-danger"><?=$valor?></p>
            <?php endforeach; ?>
        <?php endif; ?>
        <div class="form-group">
            <label for="web">Web</label>
            <input type="text" class="form-control" id="web" name="web" placeholder="Distro Official Web">
        </div>
        <?php if( isset($errors['web']) ): ?>
            <?php foreach ($errors['web'] as $valor): ?>
                <p class="bg-danger"><?=$valor?></p>
            <?php endforeach; ?>
        <?php endif; ?>
        <div class="form-group">
            <label for="doc">Doc</label>
            <input type="text" class="form-control" id="doc" name="doc" placeholder="Official Doc Website">
        </div>
        <?php if( isset($errors['doc']) ): ?>
            <?php foreach ($errors['doc'] as $valor): ?>
                <p class="bg-danger"><?=$valor?></p>
            <?php endforeach; ?>
        <?php endif; ?>
        <div class="form-group">
        ...
        <?php if( isset($errors['forum']) ): ?>
            <?php foreach ($errors['forum'] as $valor): ?>
                <p class="bg-danger"><?=$valor?></p>
            <?php endforeach; ?>
        <?php endif; ?>
        <div class="form-group">
            <label for="error">Error Tracker</label>
            <input type="text" class="form-control" id="error" name="error" placeholder="Distro Official Error Tracker Website">
        </div>
        <?php if( isset($errors['error']) ): ?>
            <?php foreach ($errors['error'] as $valor): ?>
                <p class="bg-danger"><?=$valor?></p>
            <?php endforeach; ?>
        <?php endif; ?>
        <div class="form-group">
        ...
        <?php if( isset($errors['description']) ): ?>
            <?php foreach ($errors['description'] as $valor): ?>
                <p class="bg-danger"><?=$valor?></p>
            <?php endforeach; ?>
        <?php endif; ?>
